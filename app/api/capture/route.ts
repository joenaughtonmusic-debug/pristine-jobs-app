...
export async function POST(request: Request) {
  ...
  // Nothing is routed at capture time any more — every capture waits for Joe
  // to review and approve it (see approveCaptureAction). Approval is what
  // creates the admin action / to-do and notifies the VA.
